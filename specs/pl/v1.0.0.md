...
* TOML nie zwraca uwagi na wielkość liter.
...
Znaki kontrolne inne niż tabulatory (U+0000 do U+0008, U+000A do U+001F, U+007F)
nie mogą się pojawić w komentarzu.
...
Szczegóły nt. tablic asocjacyjnych definiowanych przez klucze przedzielone
kropkami znajdują się w sekcji [Tablica asocjacyjna](#tablica-asocjacyjna)
poniżej.
...
# To definiuje wartość owoc."jabłko" jako liczbę całkowitą.
owoc."jabłko" = 1

# Ale potem traktuje owoc."jabłko" jako tabelę.
...
"jabłko"."skórka" = "cienka"
"pomarańcza"."skórka" = "gruba"

"jabłko".kolor = "czerwony"
